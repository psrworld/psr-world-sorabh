...
type ButtonColor = 'default' | 'alternative' | 'blue' | 'cyan' | 'dark' | 'gray' | 'green' | 'indigo' | 'light' | 'lime' | 'pink' | 'purple' | 'red' | 'teal' | 'yellow';
...
const buttonStyles = {
  base: "relative flex items-center justify-center rounded-lg text-center font-medium focus:outline-none focus:ring-4 transition-all duration-200",
  ...
  color: {
    default: "bg-blue-700 text-white hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800",
    alternative: "border border-gray-200 bg-white text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700",
  ...
  outlineColor: {
    default: "border border-blue-700 text-blue-700 hover:border-blue-800 hover:bg-blue-800 hover:text-white focus:ring-blue-300 dark:border-blue-600 dark:text-blue-500 dark:hover:border-blue-700 dark:hover:bg-blue-700 dark:hover:text-white dark:focus:ring-blue-800",
    alternative: "border border-gray-200 text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:ring-gray-100 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700",
    ...
    light: "border border-gray-300 text-gray-900 hover:bg-gray-100 focus:ring-gray-100 dark:border-gray-600 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700",
...
const Button: React.FC<ButtonProps> = ({
  ...
  const colorStyles = outline ? buttonStyles.outlineColor[color] : buttonStyles.color[color];
  ...
  const buttonClasses = `
    ...
    ${fullSized ? buttonStyles.fullSized : ''}
    ${grouped ? buttonStyles.grouped : ''}
